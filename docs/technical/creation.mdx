...
:::danger
This reference is out of date and will be rewritten soon. For the most up-to-date documentation, see [the SDK examples](https://github.com/abraham-ai/eden-sdk).
:::danger
